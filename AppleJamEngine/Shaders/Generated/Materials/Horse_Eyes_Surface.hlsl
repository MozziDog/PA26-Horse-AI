// Generated from D:/InternProject/HorseAI/AppleJamEngine/Content/Material/Horse/Horse_Eyes.uasset
// Domain: Surface
...
Texture2D Tex_Roughness : register(t2);
Texture2D Tex_Metallic : register(t3);

FMaterialResult EvaluateMaterial(FMaterialPixelInput Input)
{
    float4 n_18 = Tex_Diffuse.Sample(LinearWrapSampler, Input.UV0);
    float4 n_31 = Tex_Normal.Sample(LinearWrapSampler, Input.UV0);
    float3 n_81 = float3(0.500000f, 0.500000f, 1.000000f);
    float n_92 = 0.500000f;
    float3 n_83 = lerp((n_31).rgb, n_81, n_92);
    float n_69 = 1.000000f;
    float4 n_44 = Tex_Roughness.Sample(LinearWrapSampler, Input.UV0);
    float3 n_71 = (float3(n_69, n_69, n_69) - (n_44).rgb);
    float4 n_57 = Tex_Metallic.Sample(LinearWrapSampler, Input.UV0);
    float n_3 = 1.000000f;
    FMaterialResult Result;
    Result.BaseColor = (n_18).rgb;
    Result.Normal = n_83;
    Result.Roughness = (n_71).x;
    Result.Metallic = ((n_57).rgb).x;
