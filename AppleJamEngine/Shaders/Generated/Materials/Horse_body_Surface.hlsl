// Generated from D:/InternProject/HorseAI/AppleJamEngine/Content/Material/Horse/Horse_body.uasset
// Domain: Surface
...
FMaterialResult EvaluateMaterial(FMaterialPixelInput Input)
{
    ...
    float4 n_57 = Tex_Diffuse.Sample(LinearWrapSampler, Input.UV0);
    float4 n_44 = Tex_Diffuse.Sample(LinearWrapSampler, Input.UV0);
    float n_3 = 0.000000f;
    FMaterialResult Result;
    Result.BaseColor = (n_18).rgb;
    Result.Normal = (n_31).rgb;
    Result.Roughness = ((n_57).rgb).x;
    Result.Metallic = ((n_44).rgb).x;
