#!/usr/bin/env python3
"""
Generate lightweight reflection outputs for AppleJamEngine reflected headers.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate AppleJamEngine *.generated.h headers.")
    parser.add_argument(
        "--root",
        type=Path,
        default=None,
